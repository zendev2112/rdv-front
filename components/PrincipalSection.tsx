        ...
        <div className="md:col-span-6 relative">
          ...
          >
            ...
            <div className="bg-white pt-3 pb-6 md:pb-0">
              <h1 className="text-xl md:text-2xl font-bold leading-loose md:leading-relaxed">
              ...
              <p className="text-sm md:text-sm text-gray-600 mt-2 leading-loose md:leading-relaxed">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="pt-2 pb-6 md:pb-0 flex-1">
                  <h2 className="text-base md:text-base font-bold leading-loose md:leading-relaxed">

...
export default function MobileSectionNav() {
  ...
  return (
    <nav
      className={`md:hidden fixed top-[60px] left-0 right-0 z-[40] bg-primary-red text-white border-b border-light-gray overflow-x-auto scrollbar-hide transition-transform duration-300 ease-out ${

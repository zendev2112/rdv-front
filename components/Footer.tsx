        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/coronel-suarez" className="hover:text-primary-red">
                  Coronel Suárez
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/huanguelen" className="hover:text-primary-red">
                  Huanguelén
                </Link>
              </li>
              <li>
                <Link href="/la-sexta" className="hover:text-primary-red">
                  La Sexta
                </Link>
              </li>
              <li>
                <Link href="/agro" className="hover:text-primary-red">
                  Agro
                </Link>
              </li>
              <li>
                <Link href="/lifestyle" className="hover:text-primary-red">
                  Lifestyle
                </Link>
              </li>
              <li>
      ...
      <div className="container mx-auto px-4 pt-8 pb-4 mt-6 border-t border-gray-300">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-xs text-gray-600 text-center md:text-right">
            <p>
              © {new Date().getFullYear()} Radio del Volga. Todos los derechos
              reservados.
            </p>
          </div>
        </div>

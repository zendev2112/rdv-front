...
export default function MovieReleases({ articles }: MovieReleasesProps) {
  return (
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {articles.map((article) => (
            <div key={article.id} className="bg-white rounded-md shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden group">
              <Link 
                href="#" 
              ...
              >
                ...
                <div className="p-4 flex-grow">
                  ...
                  <h3 className="text-lg font-bold mb-2 leading-tight text-[#292929] group-hover:text-primary-red transition-colors">
                    <span className="text-primary-red font-bold">Estrenos.</span>{' '}
                    {article.quoteText && (

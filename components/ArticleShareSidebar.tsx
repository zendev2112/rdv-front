  ...
  return (
    <div className="flex flex-col items-center space-y-3">
      ...
      <a 
        ...
        title="X (Twitter)"
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.207-6.807-5.974 6.807H2.423l7.723-8.835L1.029 2.25h6.847l4.716 6.231 5.429-6.231zM17.09 18.719h1.828L5.887 4.097H4.013l13.077 14.622z"/></svg>
      </a>
